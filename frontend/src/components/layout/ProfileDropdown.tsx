...
const ProfileDropdown: React.FC<ProfileDropdownProps> = ({ isOpen, onClose, profileRef }) => {
  ...
  const dropdownContent = (
    <div
      ref={dropdownRef}
      className="fixed right-4 top-16 w-64 bg-white/95 backdrop-blur-md rounded-lg shadow-2xl border border-gray-200 p-3 space-y-3 animate-in slide-in-from-top-2 z-[999999999999]"
    >
      {!isSigningIn ? (
        <>
