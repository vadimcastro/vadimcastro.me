...
export function ProjectPreviewCard({ project }: ProjectPreviewCardProps) {
  return (
    <Link 
      ...
      className="block w-full h-full rounded-lg overflow-hidden bg-white border-0 md:border md:border-gray-200 transition-all duration-300 hover:shadow-md hover:scale-[1.02]"
    >
