...
export default function Home() {
  ...
  return (
    <div className="w-full px-2 md:px-4 py-1 md:py-3">
      <div>
        <section className="w-full border-0 md:border md:border-gray-200 rounded-none md:rounded-lg bg-white/60 md:bg-white shadow-none md:shadow-sm mb-2 md:mb-4">
