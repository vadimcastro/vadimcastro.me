...
// Keep only the simple header animation if you want, or remove it too
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12">
      <header className="text-center space-y-4">
        ...
        <h1 className="text-4xl font-bold">Vadim R. Castro</h1>
        <p className="text-xl text-gray-600">Software Engineer --- Platform & Data</p>
        <div className="flex justify-center space-x-6 text-sm text-mint-600">
          <a href="mailto:vadimcastro1@gmail.com" className="hover:text-mint-700">
            vadimcastro1@gmail.com
          </a>
          <a href="tel:516-509-0993" className="hover:text-mint-700">
            516-509-0993
          </a>
        </div>
      </header>
      ...
      <section className="card">
        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-mint-600">B.S. Computer Science and Applied Mathematics</p>
...
// Simplified ExperienceCard without animations
        ...
        <div className="flex-grow">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-mint-600 font-medium">{experience.role}</p>
            </div>
          ...
          {experience.technologies && (
            <div className="mt-4 flex flex-wrap gap-2">
              {experience.technologies.map((tech, i) => (
                <span 
                  key={i}
                  className="px-2 py-1 bg-mint-50 text-mint-700 text-sm rounded-full"
                >
                  {tech}
                </span>
              ))}
